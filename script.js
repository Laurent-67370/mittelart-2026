        ...
        btn.addEventListener('click', () => {
            ...
            artistItems.forEach(item => {
                ...
                if (filterValue === 'all') {
                    ...
                    // Le filtre "autre" regroupe : mixed, photo, verrier
                    if (['mixed', 'photo', 'verrier'].includes(specialty)) {
                        shouldShow = true;
                    }
                } else {
                    // Correspondance exacte (peinture ou sculpture)
                    if (specialty === filterValue) {
                        shouldShow = true;
                    }
                }

                // 3. Application de l'affichage/masquage
                if (shouldShow) {
